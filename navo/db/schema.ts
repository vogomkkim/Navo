import { pgTable, uuid, varchar, text, timestamp, jsonb, integer, boolean, index, unique, bigserial } from 'drizzle-orm/pg-core';
...
export const components = pgTable('components', {
	...
	pageOrderIdx: index('idx_components_page_order').on(table.pageId, table.orderIndex),
}));
...
export const pages = pgTable('pages', {
	...
	projectPathUnique: unique('pages_project_id_path_unique').on(table.projectId, table.path),
}));
