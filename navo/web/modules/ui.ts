...
export const saveBtn = document.getElementById(
  'saveBtn'
) as HTMLButtonElement | null;
export const chatInput = document.getElementById(
  'chatInput'
) as HTMLInputElement | null;
export const chatSendBtn = document.getElementById(
  'chatSendBtn'
) as HTMLButtonElement | null;
export const chatHistory = document.getElementById(
  'chatHistory'
) as HTMLElement | null;
export const togglePanelBtn = document.getElementById(
  'togglePanelBtn'
) as HTMLButtonElement | null;
...
export const panelOverlayEl = document.getElementById(
  'panelOverlay'
) as HTMLElement | null;
...
export const projectFeatures = document.getElementById(
  'projectFeatures'
) as HTMLTextAreaElement | null;
export const targetAudience = document.getElementById(
  'targetAudience'
) as HTMLInputElement | null;
export const businessType = document.getElementById(
  'businessType'
) as HTMLInputElement | null;
export const generateProjectBtn = document.getElementById(
  'generateProjectBtn'
) as HTMLButtonElement | null;
export const projectResult = document.getElementById(
  'projectResult'
) as HTMLElement | null;

// Suggestions elements
export const suggestionsListEl = document.getElementById(
  'suggestionsList'
) as HTMLElement | null;
export const refreshSuggestionsBtn = document.getElementById(
  'refreshSuggestionsBtn'
) as HTMLButtonElement | null;
export const toggleSuggestionsBtn = document.getElementById(
  'toggleSuggestionsBtn'
) as HTMLButtonElement | null;
export const suggestionsPanel = document.getElementById(
  'suggestionsPanel'
) as HTMLElement | null;
export const closeSuggestionsBtn = document.getElementById(
  'closeSuggestionsBtn'
) as HTMLButtonElement | null;
export const suggestionsOverlay = document.getElementById(
  'suggestionsOverlay'
) as HTMLElement | null;
...
export const logoutBtnMobile = document.getElementById(
  'logoutBtnMobile'
) as HTMLButtonElement | null;
export const profileToggle = document.getElementById(
  'profileToggle'
) as HTMLButtonElement | null;
export const profileMenu = document.getElementById(
  'profileMenu'
) as HTMLElement | null;

// Project/Page List Elements
export const projectListEl = document.getElementById(
  'projectList'
) as HTMLElement | null;
export const pageListEl = document.getElementById(
  'pageList'
) as HTMLElement | null;
export const currentPageProjectNameEl = document.getElementById(
  'currentPageProjectName'
) as HTMLElement | null;
export const projectListSectionEl = document.querySelector(
  '.project-list-section'
) as HTMLElement | null;
export const pageListSectionEl = document.querySelector(
  '.page-list-section'
) as HTMLElement | null;
export const backToProjectsBtn = document.getElementById(
  'backToProjectsBtn'
) as HTMLButtonElement | null;

// Component Builder Elements
export const createComponentBtn = document.getElementById(
  'createComponentBtn'
) as HTMLButtonElement | null;
export const componentModal = document.getElementById(
  'componentModal'
) as HTMLElement | null;
export const closeComponentModal = document.getElementById(
  'closeComponentModal'
) as HTMLButtonElement | null;
export const componentForm = document.getElementById(
  'componentForm'
) as HTMLFormElement | null;
export const previewComponentBtn = document.getElementById(
  'previewComponentBtn'
) as HTMLButtonElement | null;

// Natural Language Component Generation Elements
export const componentDescription = document.getElementById(
  'componentDescription'
) as HTMLTextAreaElement | null;
export const generateComponentBtn = document.getElementById(
  'generateComponentBtn'
) as HTMLButtonElement | null;
export const generationStatus = document.getElementById(
  'generationStatus'
) as HTMLElement | null;
...
export const toggleProjectListBtn = document.getElementById(
...
export const projectListPanel = document.getElementById(
  'projectListPanel'
) as HTMLElement | null;
export const componentBuilderPanel = document.getElementById(
...
export const closeProjectListBtn = document.getElementById(
  'closeProjectListBtn'
) as HTMLButtonElement | null;
