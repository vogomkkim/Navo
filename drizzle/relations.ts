...
import { projects, componentDefinitions, users, pages, components, userSessions, chatMessages, chatSessionSummaries } from "./schema";

export const componentDefinitionsRelations = relations(componentDefinitions, ({one, many}) => ({
