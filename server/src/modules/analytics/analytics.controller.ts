...
export function analyticsController(app: FastifyInstance) {
  ...
  // 프로젝트 이벤트 조회
  app.get(
    '/api/analytics/project/:projectId/events',
    {
  ...
  // 프로젝트 메트릭 조회
  app.get(
    '/api/analytics/project/:projectId/metrics',
    {
      preHandler: [app.authenticateToken],
    },
    async (request, reply) => {
  ...
  // 상위 페이지 조회
  app.get(
    '/api/analytics/project/:projectId/top-pages',
    {
      preHandler: [app.authenticateToken],
    },
    async (request, reply) => {
  ...
  // 상위 이벤트 조회
  app.get(
    '/api/analytics/project/:projectId/top-events',
    {
      preHandler: [app.authenticateToken],
    },
    async (request, reply) => {
  ...
  // 이벤트 트렌드 조회
  app.get(
    '/api/analytics/project/:projectId/trends',
    {
      preHandler: [app.authenticateToken],
    },
    async (request, reply) => {
  ...
  // 대시보드 데이터 조회 (통합)
  app.get(
    '/api/analytics/project/:projectId/dashboard',
    {
      preHandler: [app.authenticateToken],
    },
    async (request, reply) => {
