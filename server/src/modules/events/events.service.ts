...
export class EventsService {
    ...
    async storeUserEvents(eventsArray: EventRequest[], userId: string): Promise<number> {
        try {
    ...
    async storeErrorEvent(errorData: ErrorEventRequest, userId: string): Promise<void> {
        try {
