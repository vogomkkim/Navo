  ...
  async updatePage(pageId: string, pageData: UpdatePageData): Promise<Page> {
    try {
      ...
      if (pageData.description !== undefined)
        updateData.description = pageData.description;
      if (pageData.layoutJson !== undefined)
        updateData.layoutJson = pageData.layoutJson;
      if (pageData.isPublished !== undefined)
        updateData.isPublished = pageData.isPublished;
