...
export class IntentAnalyzer {
    ...
    private buildContextInfo(
        ...
        if (userContext.currentProject) {
            contextInfo.projectContext = `현재 작업 중인 프로젝트: ${userContext.currentProject.name}${userContext.currentProject.description
...
// 싱글톤 인스턴스
export const intentAnalyzer = new IntentAnalyzer(process.env.GEMINI_API_KEY || '');
