...
export const createOrganizationTool: Tool = {
  ...
  description:
    'Creates a new organization (tenant) for a user. If ownerId is a placeholder, it creates a dummy user.',
  inputSchema: {
    type: 'object',
    properties: {
      ...
      ownerId: {
        type: 'string',
        description:
          'The UUID of the user who owns this organization. Can be a placeholder.',
      },
    },
